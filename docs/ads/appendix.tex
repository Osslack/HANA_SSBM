...
\includepdf[pages=-,scale=.9,link,linkname=q34noI,pagecommand={}]{images/q34-no-index.pdf}
\label{pdf:q34-no-index}
\includepdf[pages=-,scale=.9,link,linkname=q34I,pagecommand={}]{images/q34-index.pdf}
\label{pdf:q34-index}
\pagebreak
