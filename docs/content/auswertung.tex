...
\section{Auswirkung der OLAP-Engine}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.49\textwidth]{images/olap_column_overall.png}
    \includegraphics[width=0.49\textwidth]{images/olap_row_overall.png}
