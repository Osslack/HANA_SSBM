...
%% des Dokuments.
\setzematrikelnrs{4278042 (Arwed Mett), 1807718 (Dominic Steinhauser)} %TODO
\setzekurs{TINF14AIBC}
\setzetitel{Ausführung des SSBM Benchmarks in der SAP HANA Datenbank}
\setzedatumAbgabe{28. März 2107 } %TODO
\setzefirma{SAP SE}
...
\setzeautor{Simon Oswald, Arwed Mett, Dominic Steinhauser, Jendrik Jordan}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
